...
exports.Understudy = function() {
  ...
  this.after = registrar('_before_interceptors');
  this.before = registrar('_after_interceptors');
  ...
  function iterate(self, interceptors, args, after) {
    ...
    function next() {
      if (i === l) {
        ...
        var used = false;
        interceptors[i++].apply(self, Array.prototype.slice.call(arguments).concat(function () {
          //
